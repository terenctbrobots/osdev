...
enum opt_code
{
  ...
  OPT_mcmodel_ = 1193,                       /* -mcmodel= */
  OPT_mcpu_ = 1194,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1195,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1196,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1197,             /* -mgeneral-regs-only */
  OPT_mlittle_endian = 1198,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1199,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1200,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1201,            /* -mlow-precision-sqrt */
  OPT_momit_leaf_frame_pointer = 1202,       /* -momit-leaf-frame-pointer */
  OPT_moverride_ = 1203,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1204,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1205,          /* -msign-return-address= */
  OPT_mstrict_align = 1206,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1207,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1208,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1209,                     /* -mtls-size= */
  OPT_mtune_ = 1210,                         /* -mtune= */
  OPT_mverbose_cost_dump = 1211,             /* -mverbose-cost-dump */
  OPT_n = 1212,                              /* -n */
  OPT_no_canonical_prefixes = 1213,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1214,              /* -no-integrated-cpp */
  OPT_no_pie = 1215,                         /* -no-pie */
  OPT_nocpp = 1216,                          /* -nocpp */
  OPT_nodefaultlibs = 1217,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1218,                   /* -nostartfiles */
  OPT_nostdinc = 1219,                       /* -nostdinc */
  OPT_nostdinc__ = 1220,                     /* -nostdinc++ */
  OPT_nostdlib = 1221,                       /* -nostdlib */
  OPT_o = 1222,                              /* -o */
  OPT_p = 1223,                              /* -p */
  OPT_pass_exit_codes = 1224,                /* -pass-exit-codes */
  /* OPT_pedantic = 1225, */                 /* -pedantic */
  OPT_pedantic_errors = 1226,                /* -pedantic-errors */
  OPT_pg = 1227,                             /* -pg */
  OPT_pie = 1228,                            /* -pie */
  OPT_pipe = 1229,                           /* -pipe */
  OPT_print_file_name_ = 1230,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1231,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1232,          /* -print-multi-directory */
  OPT_print_multi_lib = 1233,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1234,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1235,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1236,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1237,               /* -print-prog-name= */
  OPT_print_search_dirs = 1238,              /* -print-search-dirs */
  OPT_print_sysroot = 1239,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1240,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1241,                          /* -quiet */
  OPT_r = 1242,                              /* -r */
  OPT_remap = 1243,                          /* -remap */
  OPT_s = 1244,                              /* -s */
  OPT_save_temps = 1245,                     /* -save-temps */
  OPT_save_temps_ = 1246,                    /* -save-temps= */
  OPT_shared = 1247,                         /* -shared */
  OPT_shared_libgcc = 1248,                  /* -shared-libgcc */
  /* OPT_specs = 1249, */                    /* -specs */
  OPT_specs_ = 1250,                         /* -specs= */
  OPT_static = 1251,                         /* -static */
  OPT_static_libasan = 1252,                 /* -static-libasan */
  OPT_static_libgcc = 1253,                  /* -static-libgcc */
  OPT_static_libgfortran = 1254,             /* -static-libgfortran */
  OPT_static_libgo = 1255,                   /* -static-libgo */
  OPT_static_liblsan = 1256,                 /* -static-liblsan */
  OPT_static_libmpx = 1257,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1258,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1259,               /* -static-libstdc++ */
  OPT_static_libtsan = 1260,                 /* -static-libtsan */
  OPT_static_libubsan = 1261,                /* -static-libubsan */
  OPT_static_pie = 1262,                     /* -static-pie */
  /* OPT_std_c__03 = 1263, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1264, */                /* -std=c++0x */
  OPT_std_c__11 = 1265,                      /* -std=c++11 */
  OPT_std_c__14 = 1266,                      /* -std=c++14 */
  OPT_std_c__17 = 1267,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1268, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1269, */                /* -std=c++1z */
  OPT_std_c__2a = 1270,                      /* -std=c++2a */
  OPT_std_c__98 = 1271,                      /* -std=c++98 */
  OPT_std_c11 = 1272,                        /* -std=c11 */
  OPT_std_c17 = 1273,                        /* -std=c17 */
  /* OPT_std_c18 = 1274, */                  /* -std=c18 */
  /* OPT_std_c1x = 1275, */                  /* -std=c1x */
  /* OPT_std_c89 = 1276, */                  /* -std=c89 */
  OPT_std_c90 = 1277,                        /* -std=c90 */
  OPT_std_c99 = 1278,                        /* -std=c99 */
  /* OPT_std_c9x = 1279, */                  /* -std=c9x */
  OPT_std_f2003 = 1280,                      /* -std=f2003 */
  OPT_std_f2008 = 1281,                      /* -std=f2008 */
  OPT_std_f2008ts = 1282,                    /* -std=f2008ts */
  OPT_std_f2018 = 1283,                      /* -std=f2018 */
  OPT_std_f95 = 1284,                        /* -std=f95 */
  OPT_std_gnu = 1285,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1286, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1287, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1288,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1289,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1290,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1291, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1292, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1293,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1294,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1295,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1296,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1297, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1298, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1299, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1300,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1301,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1302, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1303, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1304,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1305, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1306, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1307, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1308, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1309, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1310,                     /* -std=legacy */
  OPT_symbolic = 1311,                       /* -symbolic */
  OPT_t = 1312,                              /* -t */
  OPT_time = 1313,                           /* -time */
  OPT_time_ = 1314,                          /* -time= */
  OPT_traditional = 1315,                    /* -traditional */
  OPT_traditional_cpp = 1316,                /* -traditional-cpp */
  OPT_trigraphs = 1317,                      /* -trigraphs */
  OPT_u = 1318,                              /* -u */
  OPT_undef = 1319,                          /* -undef */
  OPT_v = 1320,                              /* -v */
  OPT_version = 1321,                        /* -version */
  OPT_w = 1322,                              /* -w */
  OPT_wrapper = 1323,                        /* -wrapper */
  OPT_x = 1324,                              /* -x */
  OPT_z = 1325,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
